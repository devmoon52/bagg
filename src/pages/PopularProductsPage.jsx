...
const PopularProductsPage = () => {
  ...
  const popularProductsMap = useMemo(() => {
    let map = {};
  ...
  const selected = popularProductsMap[proId] ? popularProductsMap[proId] : null;
        ...
        <div className="max-w-7xl mx-auto space-y-3">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-2xl font-medium">
              {selected ? "Related popular products" : "Popular products"}
            </h2>
          </div>
                ...
                return (
                  ...
                  >
                    <ProductCard
                      ...
                      loading={loading}
                      relativeContainer={{
                        url: `/type/popular?proId=${product.id}`,
                      }}
