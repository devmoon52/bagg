...
const TrendingProductsPage = () => {
  ...
  // trending products map
  const trendingProductsMap = useMemo(() => {
    let map = {};
  ...
  const selected = trendingProductsMap[proId]
    ? trendingProductsMap[proId]
    : null;

  return (
    <main className={`md:space-y-10 space-y-8 ${selected && "md:my-8 my-6"}`}>
      <title>Trending products | Bagg - explore our trending products</title>
        ...
        <div className="max-w-7xl mx-auto space-y-3">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-2xl font-medium">
              {selected ? "Related trending products" : "Trending products"}
            </h2>
          </div>
                ...
                return (
                  ...
                  >
                    <ProductCard
                      ...
                      loading={loading}
                      relativeContainer={{
                        url: `/type/trendings?proId=${product.id}`,
                      }}
